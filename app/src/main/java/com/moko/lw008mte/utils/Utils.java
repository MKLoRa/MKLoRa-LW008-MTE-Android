        ...
        if (files.length == 1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                if (BuildConfig.IS_LIBRARY) {
                    ...
                    uri = FileProvider.getUriForFile(context, "com.moko.lw008mte.fileprovider", files[0]);
                }
            ...
            for (File file : files) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    if (BuildConfig.IS_LIBRARY) {
                        ...
                        fileUri = FileProvider.getUriForFile(context, "com.moko.lw008mte.fileprovider", file);
                    }
                }
                uris.add(fileUri);
