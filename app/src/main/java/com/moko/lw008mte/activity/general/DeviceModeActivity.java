...
public class DeviceModeActivity extends BaseActivity {
    ...
    private Lw008MteActivityDeviceModeBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityDeviceModeBinding.inflate(getLayoutInflater());
        ...
        mBind.tvDeviceMode.postDelayed(() -> {
            LoRaLW008MTEMokoSupport.getInstance().sendOrder(OrderTaskAssembler.getDeviceMode());
        }, 500);
    }
