...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterRawDataSwitchBinding;
...
public class FilterRawDataSwitchActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterRawDataSwitchBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityFilterRawDataSwitchBinding.inflate(getLayoutInflater());
                                ...
                                switch (configKeyEnum) {
                                    case KEY_FILTER_RAW_DATA:
                                        if (length == 13) {
                                            ...
                                            mBind.ivFilterByBxpDevice.setImageResource(value[13] == 1 ? R.drawable.lw008_ic_checked : R.drawable.lw008_ic_unchecked);
