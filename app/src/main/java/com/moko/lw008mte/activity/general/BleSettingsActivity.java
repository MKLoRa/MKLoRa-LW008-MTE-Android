...
import com.moko.lw008mte.entity.TxPowerEnum;
...
public class BleSettingsActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    private Lw008MteActivityBleSettingsBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityBleSettingsBinding.inflate(getLayoutInflater());
