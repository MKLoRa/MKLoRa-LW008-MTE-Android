...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterMkTofBinding;
...
public class FilterMKTOFActivity extends BaseActivity {
    private Lw008MteActivityFilterMkTofBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityFilterMkTofBinding.inflate(getLayoutInflater());
                                ...
                                case KEY_FILTER_MK_TOF_MFG_CODE:
                                    if (length > 0) {
                                        ...
                                        for (int i = 0, l = filterMfgCode.size(); i < l; i++) {
                                            ...
                                            View v = LayoutInflater.from(this).inflate(R.layout.lw008_mte_item_tof_filter, mBind.llMfgCode, false);
