...
import com.moko.lw008mte.databinding.Lw008MteActivityDownlinkForPosBinding;
...
public class DownlinkForPosActivity extends BaseActivity {
    ...
    private Lw008MteActivityDownlinkForPosBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityDownlinkForPosBinding.inflate(getLayoutInflater());
    ...
    public void selectPosStrategy(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW008MTEMokoSupport.getInstance().sendOrder(OrderTaskAssembler.setDownLinkPosStrategy(mSelected));
        });
