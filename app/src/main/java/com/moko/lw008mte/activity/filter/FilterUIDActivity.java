...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterUidBinding;
...
public class FilterUIDActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterUidBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw008MteActivityFilterUidBinding.inflate(getLayoutInflater());
