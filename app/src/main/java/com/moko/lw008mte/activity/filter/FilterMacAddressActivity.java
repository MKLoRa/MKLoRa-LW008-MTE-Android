package com.moko.lw008mte.activity.filter;
...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterMacAddressBinding;
...
public class FilterMacAddressActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterMacAddressBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityFilterMacAddressBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_MAC_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterMacAddress.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterMacAddressActivity.this).inflate(R.layout.lw008_mte_item_mac_address_filter, mBind.llMacAddress, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw008_mte_item_mac_address_filter, mBind.llMacAddress, false);
        TextView title = v.findViewById(R.id.tv_mac_address_title);
