...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterBxpSensorInfoBinding;
...
public class FilterBXPSensorInfoActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterBxpSensorInfoBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityFilterBxpSensorInfoBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_BXP_SENSOR_INFO_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterBXPSensorInfoActivity.this).inflate(R.layout.lw008_mte_item_tag_id_filter, mBind.llTagId, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw008_mte_item_tag_id_filter, mBind.llTagId, false);
        TextView title = v.findViewById(R.id.tv_tag_id_title);
