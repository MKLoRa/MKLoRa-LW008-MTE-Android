...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterIbeaconBinding;
...
public class FilterIBeaconActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterIbeaconBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw008MteActivityFilterIbeaconBinding.inflate(getLayoutInflater());
    ...
    private void saveParams() {
        ...
        if (TextUtils.isEmpty(majorMinStr) && TextUtils.isEmpty(majorMaxStr))
            orderTasks.add(OrderTaskAssembler.setFilterIBeaconMajorRange(0, 0));
        else {
        ...
        if (TextUtils.isEmpty(minorMinStr) && TextUtils.isEmpty(minorMaxStr))
            orderTasks.add(OrderTaskAssembler.setFilterIBeaconMinorRange(0, 0));
        else {
