...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterBxpTagIdBinding;
...
public class FilterBXPTagIdActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterBxpTagIdBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityFilterBxpTagIdBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_BXP_TAG_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterTagId.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterBXPTagIdActivity.this).inflate(R.layout.lw008_mte_item_tag_id_filter, mBind.llTagId, false);
