...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterBxpIbeaconBinding;
...
public class FilterBXPIBeaconActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterBxpIbeaconBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw008MteActivityFilterBxpIbeaconBinding.inflate(getLayoutInflater());
