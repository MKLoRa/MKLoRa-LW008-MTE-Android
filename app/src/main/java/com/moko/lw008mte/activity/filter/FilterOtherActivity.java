...
import com.moko.lw008mte.databinding.Lw008MteActivityFilterOtherBinding;
...
public class FilterOtherActivity extends BaseActivity {
    ...
    private Lw008MteActivityFilterOtherBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw008MteActivityFilterOtherBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_OTHER_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterOther.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(this).inflate(R.layout.lw008_mte_item_other_filter, mBind.llFilterCondition, false);
