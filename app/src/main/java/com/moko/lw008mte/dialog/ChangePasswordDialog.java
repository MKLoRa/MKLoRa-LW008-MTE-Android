...
import com.moko.lw008mte.databinding.Lw008MteDialogChangePasswordBinding;
import com.moko.lw008mte.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw008MteDialogChangePasswordBinding> {
    ...
    @Override
    protected Lw008MteDialogChangePasswordBinding getViewBind() {
        return Lw008MteDialogChangePasswordBinding.inflate(getLayoutInflater());
    }
