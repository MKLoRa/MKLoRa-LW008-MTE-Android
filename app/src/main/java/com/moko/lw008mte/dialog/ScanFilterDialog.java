...
import com.moko.lw008mte.databinding.Lw008MteDialogScanFilterBinding;

public class ScanFilterDialog extends com.moko.lw008mte.dialog.BaseDialog<Lw008MteDialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw008MteDialogScanFilterBinding getViewBind() {
        return Lw008MteDialogScanFilterBinding.inflate(getLayoutInflater());
    }
