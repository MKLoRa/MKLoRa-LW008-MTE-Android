...
import com.moko.lw008mte.databinding.Lw008MteDialogPasswordBinding;
import com.moko.lw008mte.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw008MteDialogPasswordBinding> {
    ...
    @Override
    protected Lw008MteDialogPasswordBinding getViewBind() {
        return Lw008MteDialogPasswordBinding.inflate(getLayoutInflater());
    }
