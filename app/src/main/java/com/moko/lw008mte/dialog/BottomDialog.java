...
import com.moko.lw008mte.databinding.Lw008MteDialogBottomBinding;

import java.util.ArrayList;

public class BottomDialog extends MokoBaseDialog<Lw008MteDialogBottomBinding> {
    ...
    @Override
    protected Lw008MteDialogBottomBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw008MteDialogBottomBinding.inflate(inflater, container, false);
    }
