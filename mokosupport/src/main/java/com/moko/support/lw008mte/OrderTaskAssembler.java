...
import com.moko.support.lw008mte.task.GetFirmwareRevisionTask;
import com.moko.support.lw008mte.task.GetHardwareRevisionTask;
import com.moko.support.lw008mte.task.GetManufacturerNameTask;
import com.moko.support.lw008mte.task.GetModelNumberTask;
import com.moko.support.lw008mte.task.GetSerialNumberTask;
import com.moko.support.lw008mte.task.GetSoftwareRevisionTask;
import com.moko.support.lw008mte.task.ParamsReadTask;
import com.moko.support.lw008mte.task.ParamsWriteTask;
import com.moko.support.lw008mte.task.SetPasswordTask;
...
//    public static OrderTask getTimePeriodicPosReportInterval() {
//        ParamsReadTask task = new ParamsReadTask();
//        task.setData(ParamsKeyEnum.KEY_TIME_PERIODIC_MODE_REPORT_INTERVAL);
//        return task;
//    }
...
//    }
    ...
    public static OrderTask setIndicatorStatus(@IntRange(from = 0, to = 1) int lowPowerEnable,
        ...
        ParamsWriteTask task = new ParamsWriteTask();
        task.setIndicatorStatus(lowPowerEnable,
    ...
    public static OrderTask setOffByMagnetic(@IntRange(from = 0, to = 1) int type) {
        ParamsWriteTask task = new ParamsWriteTask();
        task.setOffByMagnetic(type);
        return task;
    }
